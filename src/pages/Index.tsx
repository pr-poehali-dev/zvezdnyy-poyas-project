...
const BRIDGE_DETAILS: BridgeDetail[] = [
  ...
  },
  {
    ...
    stat: "260 м",
    statLabel: "длина",
    description: "Главный символ Петербурга. Разводные крылья Дворцового моста — визитная карточка города, узнаваемая во всём мире.",
    icon: "Landmark",
    facts: [
      "Дворцовый мост перекинут через Большую Неву, соединяя Адмиралтейский остров с Васильевским.",
      "Длина моста — 260 метров, ширина — около 27 метров.",
      "Построен в 1916 году по проекту инженера Андрея Пшеницкого.",
      "Разводной пролёт в центре открывается для прохода судов дважды в сутки в навигационный сезон.",
      "Ночной развод моста стал символом белых ночей и туристической эмблемой города.",
      "С моста открывается прямой вид на Зимний дворец и стрелку Васильевского острова.",
    ],
    year: "1916",
    length: "260 м",
    river: "Нева",
  },
  {
    ...
    stat: "1720-е",
    statLabel: "год постройки",
    description: "Один из старейших мостов города, перекинутый через Зимнюю канавку у Нового Эрмитажа. Скромный, но исторически значимый.",
    icon: "History",
    facts: [
      "1-й Зимний мост перекинут через Зимнюю канавку в районе Дворцовой набережной.",
      "Зимняя канавка — один из старейших каналов Петербурга, прорытый ещё при Петре I.",
      "Мост однопролётный, гранитный, лаконичный по архитектуре.",
      "Соседствует с Эрмитажным мостом, образуя вместе с ним историческую анфиладу переправ.",
      "По канавке проходили лодки из Невы к Зимнему дворцу.",
      "Место тихое и атмосферное — сюда приходят, чтобы уйти от туристического шума.",
    ],
    year: "1720-е",
    length: "около 15 м",
    river: "Зимняя канавка",
  ...
  {
    id: "panteleymоnovskiy",
    tag: "Ажур",
    name: "Пантелеймоновский мост",
    stat: "1806",
    statLabel: "год постройки",
    description: "Изящный цепной мост через Фонтанку с позолоченными орлами и ажурными цепями — один из красивейших в городе.",
    icon: "Link",
    facts: [
      "Пантелеймоновский мост перекинут через реку Фонтанку у Летнего сада.",
      "Построен в 1906 году, однако цепная переправа на этом месте существовала с 1824 года.",
      "Украшен чугунными фонарями, позолоченными двуглавыми орлами и декоративными цепями.",
      "Назван в честь церкви Святого Пантелеймона, расположенной неподалёку.",
      "Рядом — Михайловский замок и Летний сад, что делает прогулку здесь особенно живописной.",
      "Мост пешеходный, что придаёт ему камерность и особое очарование.",
    ],
    year: "1906",
    length: "43 м",
    river: "Фонтанка",
...
const BRIDGE_LIST = [
  ...
  { n: "22", name: "Дворцовый мост" },
  { n: "23", name: "1-й Зимний мост" },
  { n: "24", name: "Пантелеймоновский мост" },
];
