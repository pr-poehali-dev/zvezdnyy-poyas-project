      ...
      <section className="px-4 md:px-8 bg-white py-[195px] rounded-none">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-black">
            {/* 3 cards */}
            {/* Гигант */}
              <div className="group flex flex-col gap-4 p-8 border-r border-black hover:bg-red-600 transition-colors duration-200">
                ...
                <div className="text-xs uppercase tracking-widest text-red-600 group-hover:text-white/70 transition-colors">Гигант</div>
                <h3 className="text-2xl font-bold tracking-tighter group-hover:text-white transition-colors">Синий мост</h3>
                <div className="text-5xl font-bold text-neutral-200 group-hover:text-white/20 transition-colors">97 м</div>
              ...
              <div className="group flex flex-col gap-4 p-8 border-r border-black hover:bg-red-600 transition-colors duration-200">
                ...
                <div className="text-xs uppercase tracking-widest text-red-600 group-hover:text-white/70 transition-colors">Ветеран</div>
                <h3 className="text-2xl font-bold tracking-tighter group-hover:text-white transition-colors">Эрмитажный мост</h3>
                <div className="text-5xl font-bold text-neutral-200 group-hover:text-white/20 transition-colors">1763</div>
                <p className="text-neutral-500 group-hover:text-white/80 text-sm leading-relaxed transition-colors">
              ...
              {/* Шедевр */}
              <div className="group flex flex-col gap-4 p-8 hover:bg-red-600 transition-colors duration-200">
                <div className="w-12 h-12 border-2 border-black group-hover:border-white flex items-center justify-center shrink-0 transition-colors">
                  <Icon name="Sparkles" size={22} className="text-black group-hover:text-white transition-colors" />
                </div>
                <div className="text-xs uppercase tracking-widest text-red-600 group-hover:text-white/70 transition-colors">Шедевр</div>
                <h3 className="text-2xl font-bold tracking-tighter group-hover:text-white transition-colors">Троицкий мост</h3>
                <div className="text-5xl font-bold text-neutral-200 group-hover:text-white/20 transition-colors">582 м</div>
                <p className="text-neutral-500 group-hover:text-white/80 text-sm leading-relaxed transition-colors">
